...
import { n as registerLayoutLoaders } from "./chunk-N4CR4FBY-BvPrzEpI.js";
...
var id = "c4", c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./flowDiagram-NV44I4VS-DK0fvim2.js");
		return {
			id: id2,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./erDiagram-Q2GNP2WA-F2chKLFe.js");
		return {
			id: id4,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./gitGraphDiagram-NY62KEGX-CUdPdghz.js");
		return {
			id: id5,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./infoDiagram-F6ZHWCRC-n8FffDWH.js");
		return {
			id: id7,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./pieDiagram-ADFJNKIX-B7c7ggOS.js");
		return {
			id: id8,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./requirementDiagram-UZGBJVZJ-Cp_9MNrV.js");
		return {
			id: id11,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./classDiagram-2ON5EDUG-5kyk1iv-.js");
		return {
			id: id13,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./classDiagram-v2-WZHVMYZB-DPx7YDLo.js");
		return {
			id: id14,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./stateDiagram-FKZM4ZOC-CDXdq8u9.js");
		return {
			id: id15,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./stateDiagram-v2-4FDKWEC3-DUCSe8nl.js");
		return {
			id: id16,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./mindmap-definition-VGOIOE7T-B9hcxoJm.js");
		return {
			id: id20,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./diagram-S2PKOQOG-5KGtxe_m.js");
		return {
			id: id23,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./diagram-QEK2KX5R-B-3Kl_gK.js");
		return {
			id: id24,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./blockDiagram-VD42YOAC-BxKXYcyj.js");
		return {
			id: id25,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./architectureDiagram-VXUJARFQ-Bye8ZkFH.js");
		return {
			id: id26,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./diagram-PSM6KHXK-zOPWabxz.js");
		return {
			id: id27,
			diagram: e
		};
