...
import { a as decodeEntities, f as isDetailedError, g as utils_default, h as removeDirectives, i as cleanAndMerge, o as encodeEntities } from "./chunk-S3R3BYOJ-BI-BEfpj.js";
...
import { i as registerIconPacks, s as dedent } from "./chunk-JA3XYJ7Z-DLTLD5Qe.js";
...
import { n as registerLayoutLoaders } from "./chunk-N4CR4FBY-vW6kPLGX.js";
...
var id = "c4", c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./c4Diagram-YG6GDRKO-dlOaWF1g.js");
		return {
			id,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./flowDiagram-NV44I4VS-C-HA201B.js");
		return {
			id: id2,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./erDiagram-Q2GNP2WA-DTSJhfig.js");
		return {
			id: id4,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./gitGraphDiagram-NY62KEGX-Bwm3yyui.js");
		return {
			id: id5,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./ganttDiagram-LVOFAZNH-Y2-wACpB.js");
		return {
			id: id6,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./infoDiagram-F6ZHWCRC-D_eQW5gy.js");
		return {
			id: id7,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./pieDiagram-ADFJNKIX-rRVhhCxf.js");
		return {
			id: id8,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./xychartDiagram-PRI3JC2R-BMVPYIVP.js");
		return {
			id: id10,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./requirementDiagram-UZGBJVZJ-CVO799vb.js");
		return {
			id: id11,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./sequenceDiagram-WL72ISMW-BJSz4ME3.js");
		return {
			id: id12,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./classDiagram-2ON5EDUG-ADLpJwJg.js");
		return {
			id: id13,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./classDiagram-v2-WZHVMYZB-BOXpnOQd.js");
		return {
			id: id14,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./stateDiagram-FKZM4ZOC-CotuSAsm.js");
		return {
			id: id15,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./stateDiagram-v2-4FDKWEC3-CDZ6MLHT.js");
		return {
			id: id16,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./journeyDiagram-XKPGCS4Q-DKau_CMM.js");
		return {
			id: id17,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./mindmap-definition-VGOIOE7T-BAFpOKvk.js");
		return {
			id: id20,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./kanban-definition-3W4ZIXB7-BEa3mliQ.js");
		return {
			id: id21,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./diagram-S2PKOQOG-CCGHwnhd.js");
		return {
			id: id23,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./diagram-QEK2KX5R-DueOmPii.js");
		return {
			id: id24,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./blockDiagram-VD42YOAC-CVZcsamp.js");
		return {
			id: id25,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./architectureDiagram-VXUJARFQ-DSisUxyj.js");
		return {
			id: id26,
			diagram: e
		};
	...
	loader: /* @__PURE__ */ __name(async () => {
		let { diagram: e } = await import("./diagram-PSM6KHXK-B1nZFAOc.js");
		return {
			id: id27,
			diagram: e
		};
