import { f as __name } from "./chunk-FPAJGGOC-BlFh-ztF.js";
var parsers = {}, initializers = {
	info: /* @__PURE__ */ __name(async () => {
		let { createInfoServices: e } = await import("./info-NVLQJR56-DseAT-Wi.js");
		parsers.info = e().Info.parser.LangiumParser;
	}, "info"),
	packet: /* @__PURE__ */ __name(async () => {
		let { createPacketServices: e } = await import("./packet-BFZMPI3H-Cj7D1ZR8.js");
		parsers.packet = e().Packet.parser.LangiumParser;
	}, "packet"),
	pie: /* @__PURE__ */ __name(async () => {
		let { createPieServices: e } = await import("./pie-7BOR55EZ-LtvVUyWM.js");
		parsers.pie = e().Pie.parser.LangiumParser;
	}, "pie"),
	architecture: /* @__PURE__ */ __name(async () => {
		let { createArchitectureServices: e } = await import("./architecture-U656AL7Q-LEuj8_SD.js");
		parsers.architecture = e().Architecture.parser.LangiumParser;
	}, "architecture"),
	gitGraph: /* @__PURE__ */ __name(async () => {
		let { createGitGraphServices: e } = await import("./gitGraph-F6HP7TQM-DJAKaPBr.js");
		parsers.gitGraph = e().GitGraph.parser.LangiumParser;
	}, "gitGraph"),
	radar: /* @__PURE__ */ __name(async () => {
		let { createRadarServices: e } = await import("./radar-NHE76QYJ-CrQ4SMQ7.js");
		parsers.radar = e().Radar.parser.LangiumParser;
	}, "radar"),
	treemap: /* @__PURE__ */ __name(async () => {
		let { createTreemapServices: e } = await import("./treemap-KMMF4GRG-B-DNqOWo.js");
